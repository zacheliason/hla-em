...
It also saves a csv file of the results and scores. This file contains the expected and predicted genotypes for each sample. It also records the mean accuracy of each trial per typing level (two, four, six, and eight-digit).
