...
## 1. Simulated Test Case Generation *(start here)*
...
```
python src/simulate_reads.py [options]
```
...
```
python3 src/simulate_reads.py -r /Users/zacheliason/Downloads/hla-em/hla_gen.fasta -m /Users/zacheliason/Downloads/hla-em/EnsembleGenome_STAR_without_scaffolds
```
...
I wrote the bash script `run_hla_em_pipeline.sh` to automate the process of running HLA-EM on each of the test cases generated by `simulate_reads.py`.
